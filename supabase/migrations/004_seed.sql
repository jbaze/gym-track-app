...
('Dumbbell Lateral Raise',    'shoulders',   array[],                               'dumbbell',   'Lateral raise for medial deltoid isolation'),
...
('Cable Lateral Raise',       'shoulders',   array[],                               'cable',      'Low-pulley lateral raise for constant tension'),
...
('Concentration Curl',        'biceps',      array[],                               'dumbbell',   'Seated isolation curl for peak contraction'),

-- TRICEPS (6 exercises)
('Skull Crushers',            'triceps',     array[],                               'barbell',    'Lying tricep extension with EZ-bar or barbell'),
('Tricep Pushdown',           'triceps',     array[],                               'cable',      'High-pulley rope or bar pushdown for tricep isolation'),
('Close-Grip Bench Press',    'triceps',     array['chest','shoulders'],            'barbell',    'Narrow grip bench press emphasizing triceps'),
('Overhead Tricep Extension', 'triceps',     array[],                               'dumbbell',   'Overhead extension for long head of tricep'),
('Tricep Kickback',           'triceps',     array[],                               'dumbbell',   'Bent-over dumbbell kickback for tricep isolation'),
...
('Leg Extension',             'quads',       array[],                               'machine',    'Seated machine extension for quad isolation'),
...
('Lying Leg Curl',            'hamstrings',  array[],                               'machine',    'Prone machine curl for hamstring isolation'),
('Good Mornings',             'hamstrings',  array['glutes','lower back'],          'barbell',    'Barbell good morning for posterior chain'),
('Seated Leg Curl',           'hamstrings',  array[],                               'machine',    'Seated machine curl for hamstring isolation'),
...
-- CALVES (4 exercises)
('Standing Calf Raise',       'calves',      array[],                               'machine',    'Standing machine or smith machine calf raise'),
('Seated Calf Raise',         'calves',      array[],                               'machine',    'Seated machine calf raise targeting soleus'),
('Donkey Calf Raise',         'calves',      array[],                               'machine',    'Bent-over calf raise for peak contraction'),
('Single-Leg Calf Raise',     'calves',      array[],                               'bodyweight', 'Unilateral calf raise for balance and isolation'),

-- CORE (6 exercises)
('Plank',                     'core',        array['shoulders'],                    'bodyweight', 'Isometric hold in a push-up position'),
('Cable Crunch',              'core',        array[],                               'cable',      'Kneeling cable crunch for weighted ab work'),
...
('Russian Twist',             'core',        array[],                               'other',      'Seated rotation for oblique development'),
...
('Wrist Curl',                'forearms',    array[],                               'barbell',    'Seated barbell wrist curl for forearm flexors'),
